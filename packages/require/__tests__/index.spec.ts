...
describe("@zodash/require", () => {
  it('works', () => {
    requirejs.register('@browser/debug.js', function (module, exports, require) {
  ...
  it('deps', () => {
    requirejs.register('@browser/add.js', function (module, exports, require) {
      module.exports = (x: number, y: number) => {
        return x + y;
      };
    });

    requirejs.register('@browser/sub.js', function (module, exports, require) {
      module.exports = (x: number, y: number) => {
        return x - y;
      };
    });

    requirejs.register('@browser/utils.js', function (module, exports, require) {
  ...
  it('deps deep', () => {
    requirejs.register('@browser/c.js', function (module, exports, require) {
      module.exports = (x: number, y: number) => {
        return x + y;
      };
    });

    requirejs.register('@browser/b.js', function (module, exports, require) {
      module.exports = (x: number, y: number) => {
        return require('@browser/c')(x - 1, y);
      };
    });

    requirejs.register('@browser/a.js', function (module, exports, require) {
      module.exports = (x: number, y: number) => {
  ...
  it('deps circle', () => {
    requirejs.register('@zodash/pick.js', function (module, exports, require) {
    ...
    requirejs.register('@zodash/omit.js', function (module, exports, require) {
    ...
    requirejs.register('@zodash/utils.js', function (module, exports, require) {
  ...
  it('project app', () => {
    requirejs.register('./controllers', function (module, exports, require) {
      module.exports = {
        c1: () => {
    ...
    requirejs.register('./models', function (module, exports, require) {
      module.exports = {
        m1: () => {
          console.log('model 1');
        },
    ...
    requirejs.register('./services', function (module, exports, require) {
      module.exports = {
        s1: () => {
    ...
    requirejs.register('./app.js', function (module, exports, require) {
