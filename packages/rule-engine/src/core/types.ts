 ...
 */
export type IOnScaleTo<DataSource> = (dataSource: Partial<DataSource>, attributeName: string) => Promise<string>;
 ...
 * @param dataSource dataSource
 */
export type IOnHitAttr<DataSource> = (attributeName: string, dataSource: DataSource) => Promise<void>;
